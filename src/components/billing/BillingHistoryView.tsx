...
import { Download, ArrowLeft, CreditCard, Calendar, CheckCircle2, AlertTriangle, ArrowRight } from "lucide-react";
...
export const BillingHistoryView: React.FC = () => {
  const { currentPlanId, plans, paymentHistory, subscription, addNotification } = useApp();
